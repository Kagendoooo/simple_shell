...
/**
  *man_all- Displays all possible shellby commands
 */
...
/**
  *man_alias-Displays information on shellby command 'alias'
 */
...
/**
  *man_cd-Displays information on shellby command 'cd'
 */
void man_cd(void)
{
	...
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "\tThe envrment variables PWD and OLDPWD are updated ";
	write(STDOUT_FILENO, msg, _strlen(msg));
...
/**
 *man_exit-Displays information on shellby command 'exit'
 */
void man_exit(void)
{
...
/**
 *man_help-Displays information on shellby command 'help'
 */
void man_help(void)
{
